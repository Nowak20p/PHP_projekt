...
if (preg_match($nazwaVal, $nazwa) || (preg_match($hasloVal, $haslo)) || (preg_match($emailVal, $email)) || (preg_match($miastoVal, $miasto)) || (preg_match($miastoVal, $miasto)) || (preg_match($kodVal, $kod)) || (preg_match($ulicaVal, $ulica))) {
    ...
    echo "Dziekujemy za utworzenie konta";
} else {
    echo "Nieprprawnie wpisane dane";
}
